...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    gba::Vector2<T> getPosition() const;
...
/// (Vector2 and Vector3).
///
/// To keep things simple, gba::Rect doesn't define
/// functions to emulate the properties that are not directly
/// members (such as right, bottom, center, etc.), it rather
/// only provides intersection functions.
///
/// gba::Rect uses the usual rules for its boundaries:
/// \li The left and top edges are included in the rectangle's area
/// \li The right (left + width) and bottom (top + height) edges are excluded from the rectangle's area
///
/// This means that gba::IntRect(0, 0, 1, 1) and gba::IntRect(1, 1, 1, 1)
/// don't intersect.
///
/// gba::Rect is a template and may be used with any numeric type, but
/// for simplicity the instantiations used by SFML are typedef'd:
/// \li gba::Rect<int> is gba::IntRect
/// \li gba::Rect<float> is gba::FloatRect
///
...
/// gba::IntRect r1(0, 0, 20, 5);
///
/// // Define another rectangle, located at (4, 2) with a size of 18x10
/// gba::Vector2i position(4, 2);
/// gba::Vector2i size(18, 10);
/// gba::IntRect r2(position, size);
///
